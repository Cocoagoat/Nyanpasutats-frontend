  ...
  return (
    <div className=" mx-auto my-12 w-full max-w-front-n-center-60 bg-blue-990  p-4 text-center text-slate-200">
      ...
      <p className="mx-auto mt-4 max-w-2xl">
        <b>Disclaimer</b> : The database is updated roughly once a month, so the
        affinities shown here may be a lot less extreme than they were when it
        was last updated - you can click on each username and check the affinity
        directly on MAL. You never know, maybe it got even higher/lower since
        then.
      </p>
